...
import PlumbingPageSchema from '@/app/industries/plumbing/components/PlumbingPageSchema';
...
const PlumbingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-white">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg p-1">
                  <div className="bg-black rounded-lg overflow-hidden">
                    <Image 
                      ...
                      alt="Plumbing Marketing Dashboard" 
                      width={600} 
                      height={400}
                ...
                <div className="absolute -bottom-6 -right-6 bg-blue-600 rounded-xl p-4 shadow-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold">147% More Leads</span>
                  </div>
                </div>
                
                <div className="absolute -top-6 -left-6 bg-blue-900 rounded-xl p-4 shadow-xl">
                  <div className="flex items-center gap-2">
                    <FaStar className="text-yellow-400" />
                    <span className="text-sm font-bold">9.2x ROI</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Services Section */}
      <section className="py-20 bg-blue-900/30 services-overview">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Complete Plumbing Marketing Solutions
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We handle every aspect of your online presence so you can focus on running your plumbing business.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-black/50 rounded-xl p-8 border border-blue-800/30 hover:border-blue-500/50 transition duration-300">
              ...
              <p className="text-gray-400 mb-4">
                Rank at the top of Google Maps and local search results when homeowners search for plumbing services in your area.
              </p>
            ...
            <div className="bg-black/50 rounded-xl p-8 border border-blue-800/30 hover:border-blue-500/50 transition duration-300">
              ...
              <h3 className="text-xl font-bold mb-4">Plumber PPC Campaigns</h3>
              <p className="text-gray-400 mb-4">
                Targeted pay-per-click advertising that puts your plumbing services in front of homeowners actively searching for help.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <FaCheckCircle className="text-blue-500 mr-2" />
